...
export const Hero = () => {
    // Scroll handler bypasses React Router to natively scroll to the element
        ...
        <section className="pt-5 pb-20 px-6 text-center transition-colors">
            <div className="relative pt-5 pb-5 px-6 text-center transition-colors">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    ...
                    <a href="#how-it-works"
                       ...
                       className="text-text font-medium hover:text-primary transition-colors flex items-center gap-2 cursor-pointer">
            ...
            <div className="py-5 px-6 transition-colors ">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl font-bold text-center text-text mb-12">Our Engineering Arsenal</h2>
